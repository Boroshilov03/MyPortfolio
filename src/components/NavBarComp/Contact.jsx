    ...
    <div className="lg:flex lg:ml-5 pb-14 my-8">
      <div className="w-1/2">
        ...
        <div className="flex flex-col items-start mt-5 gap-2">
          ...
          <a href="tel:+15627533089" className="font-light inline-flex gap-1 items-center mt-5">
      ...
      <div className="w-1/2">
        ...
        <div className="flex flex-col items-start mt-5 gap-2 text">
          ...
          LinkedIn</a>
          <a href="https://www.instagram.com/mirlan_bb/" className="font-light inline-flex gap-1 items-center mt-5">
