    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-white py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Full-Stack Developer passionate about creating innovative solutions and meaningful digital experiences.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#aboutSection" className="text-gray-400 hover:text-white transition-colors duration-300">
                  About
                </a>
              </li>
              <li>
                <a href="#workSection" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Projects
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400">Long Beach, California</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Mirlan Boroshilov. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
