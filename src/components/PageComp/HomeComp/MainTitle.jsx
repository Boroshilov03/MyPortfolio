      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          <div className="mb-6">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-600 mb-8 leading-relaxed">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-400 mb-8 leading-relaxed">
              ...
              meaningful digital experiences. Currently pursuing Computer
              Science at CSULB with hands-on experience in modern web
              technologies.
            </p>
          </div>
