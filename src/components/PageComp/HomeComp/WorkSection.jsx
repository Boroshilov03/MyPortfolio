  ...
  const data = [
    {
      ...
      link: GPT,
      description:
        "Modern UI/UX design for GPT-3 integration with responsive layout and intuitive user experience.",
    ...
    },
    {
      ...
      link: FoodTruck,
      description:
        "A comprehensive food truck discovery platform with location-based search and real-time updates.",
    ...
    },
    {
      ...
      link: BudgetPal,
      description:
        "Personal finance management application with expense tracking, budgeting tools, and financial insights.",
    ...
    },
    {
      ...
      link: QuoteGen,
      description:
        "Interactive quote generator with beautiful animations and social sharing capabilities.",
    ...
    },
    {
      ...
      link: J4J,
      description:
        "Job marketplace platform connecting employers with skilled professionals in various industries.",
    ...
    },
    {
      ...
      link: MovieLand,
      description:
        "Movie discovery and recommendation platform with advanced filtering and user reviews.",
