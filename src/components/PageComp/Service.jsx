  ...
  return (
    <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-300 mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
          {title}
        </h3>
  ...
  const data = [
    {
      title: "Web Design & UI",
      description:
        "Designing responsive, accessible interfaces with a focus on user experience and modern front-end practices.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Building and deploying robust applications with React, Python/Flask or Django, and SQL/NoSQL databases.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Working in agile teams, contributing to code reviews, writing tests, and maintaining clear documentation.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mt-6 max-w-2xl mx-auto">
            As a software engineering student and intern, I enjoy building
            modern web applications and collaborating with teams to deliver
            clean, scalable code. Below are some areas where I’ve gained the
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              I’m excited to contribute to innovative teams and grow as a
              software engineer. Let’s chat about opportunities to build
